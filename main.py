...
def send_notification_email(name, from_email, message):
    ...
    body = f"""
    Поступило новое сообщение с вашего сайта-визитки:
    ...
    ---
    Это сообщение отправлено автоматически с вашего сайта.
    """
...
if __name__ == '__main__':
    # Создаем файл для комментариев, если он не существует
